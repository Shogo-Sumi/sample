...
//3科目合計点が最も高い人のname
//全体のgeographyの標準偏差
//mathの点数が高い順にソート。ただしmathが同店の場合は、chemistryの点数が高い順に、さらに同店の時はgeography点数が高い順にソートする。
//ただし、for,whileを使わない。
...
const sortedData = [...data].sort((a, b) => {
  ...
  // mathが同点である場合、chemistryの比較
  if (a.chemistry !== b.chemistry) return b.chemistry - a.chemistry;
  // mathとchemistryが同点である場合、geograpyの比較
  return b.geography - a.geography;
});

console.log("ソートされたデータ");
console.log(sortedData);
console.log("ソートされていないデータ");
console.log(data);
